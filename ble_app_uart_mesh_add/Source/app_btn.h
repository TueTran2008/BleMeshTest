...
#define APP_BTN_HOLD_SO_LONG_TIME_MS             ((uint32_t)1200) 
#define APP_BTN_ON_HOLD_TIME_FIRE_EVENT_MS       ((uint32_t)50) 
#define APP_BTN_DOUBLE_CLICK_TIME_MS             ((uint32_t)200)
